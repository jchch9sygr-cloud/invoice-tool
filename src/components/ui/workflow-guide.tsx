...
import { Settings, Users, FileText, Mail, CheckCircle2, AlertTriangle, ArrowDown } from 'lucide-react';
...
const workflowSteps: WorkflowStep[] = [
  {
    ...
    description: "Logo, Adresse, Bankverbindung eingeben und speichern",
    color: "blue",
  },
  {
    icon: Users,
    title: "2. Kunden anlegen",
    description: "Name, Adresse und Kontaktdaten deiner Kunden erfassen",
    color: "purple",
  },
  {
    icon: FileText,
    title: "3. Rechnung erstellen",
    description: "Kunde wählen, Positionen eintragen, PDF herunterladen",
    color: "green",
  },
  {
    icon: Mail,
    title: "4. Versenden & Status setzen",
    description: "Per E-Mail senden oder PDF verschicken, dann Status auf 'Gesendet'",
    color: "yellow",
  },
  {
    icon: CheckCircle2,
    title: "5. Bezahlung markieren",
    description: "Wenn bezahlt, Status auf 'Bezahlt' setzen",
    color: "emerald",
  },
  {
    icon: AlertTriangle,
    title: "6. Bei Verzug: Mahnung",
    description: "Überfällige Rechnung? Im Mahnwesen Mahnung erstellen",
    color: "orange",
  },
];
